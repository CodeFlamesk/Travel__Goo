(() => {
    ...
    isWebp();
    menuInit();
    const swipers = document.querySelector(".tabs__slider");
    const swiperWrapper = document.querySelector(".tabs__wrapper");
    const swiperSlides = document.querySelectorAll(".tabs__slide");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        document.addEventListener("click", (function(event) {
            if (!hiddenContent.contains(event.target) && event.target !== heartIcon) hiddenContent.style.display = "none";
        }));
    }));
